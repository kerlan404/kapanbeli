...
// Endpoint untuk membuat produk baru - will be handled in server.js with upload middleware
// router.post('/', productsController.create);

// Endpoint untuk memperbarui produk - will be handled in server.js with upload middleware
